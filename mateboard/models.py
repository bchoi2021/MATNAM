...
class MateBoard(models.Model):
    ...
    like_users = models.ManyToManyField('user.User',
                            related_name='mate_like_articles')
    voter = models.ManyToManyField('user.User', related_name='mate_voter_question')
...
class MateAnswer(models.Model):
    author = models.ForeignKey('user.User', on_delete=models.CASCADE,
                               related_name='mate_author_answer', null=True, blank=True)
    question = models.ForeignKey(MateBoard, on_delete=models.CASCADE)
    content = models.TextField()
    create_date = models.DateTimeField(null=True)
    voter = models.ManyToManyField('user.User', related_name='mate_voter_answer')    
